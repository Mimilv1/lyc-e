...
def lesboutons():
    ...
    bouton_plus_vitesse=Button(fenetre, text="+ de vitesse de base", font=("courrier",25), bg="#164839", fg='white',command=on_change_vitesse("+"))
    bouton_plus_vitesse.pack(side=BOTTOM)
    bouton_moins_vitesse=Button(fenetre, text="- de vitesse de base", font=("courrier",25), bg="#164839", fg='white',command=on_change_vitesse("-"))
    bouton_moins_vitesse.pack(side=BOTTOM)

def on_change_vitesse(plus_ou_moins):
    if plus_ou_moins=="+":
        =+0.1
        print(e)
    elif +!=0:
