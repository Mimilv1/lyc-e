...
l=1000
h=600
liste_variable=[l-(l*0.057),h-(h*0.1),pi,7]#x ballon ,y ballon , x ballon 2,y ballon 2,angle ballon ,vitesse ballon au début
...
def c_repartit():
    print("kboom")
    #dessin.move(ballon,"""différence origine position actuelle,différence origine position actuell""")
    #vballon=liste_variable
